...
-->
                                <?php
									...
									if ($result->num_rows > 0){
                                        ...
                                        echo "<table>";
                                        echo "<tr><th>Ranking</th><th>Team Name</th><th>Wins</th><th>Losses</th><th>OtherCol</th></tr>";
                                        
                                        
										while($row = $result->fetch_assoc()){
											echo "<tr><th>". $row["TeamRank"] . "</th><th>" . $row["TeamName"] . "</th><th>" . $row["Wins"] . "</th><th>" . $row["Losses"]. "</tr>";
										}
									} else {
										echo "0 results";
									}
